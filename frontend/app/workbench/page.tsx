...
const seedDataset: Item[] = [
  ...
  },
  {
    ...
    confidence: 96,
    invoice: 'DIABLO Â½X18 SANDING BELT 6',
  ...
  {
    sku: '77BC21',
    name: 'Industrial Pressure Gauge 0â€“10 bar Bottom Mount',
  ...
  return (
    ...
    >
      ...
      <span className="font-mono text-[11px]">
        {count}/{type === 'invoice' ? 40 : '60â€“80'} CHARS â€”{' '}
              ...
              >
                {isLaunching ? (
                  ...
                  <>
                    ...
                    Launch Pipeline for {filtered.length} Items â†’
                  </>
                )}
              </button>
      ...
      <div className="flex flex-col gap-4">
        <div>
          <p className="mb-2 font-mono text-[10px] uppercase tracking-wider text-muted-foreground">
            Invoice description (â‰¤40 chars)
          </p>
        ...
        <div>
          <p className="mb-2 font-mono text-[10px] uppercase tracking-wider text-muted-foreground">
            Mobile description (60â€“80 chars)
          </p>
